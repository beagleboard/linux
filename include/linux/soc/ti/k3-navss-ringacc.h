...
/**
 * of_k3_nav_ringacc_get_by_phandle - find a RA by phandle property
 * @np: device node
 * @propname: property name containing phandle on RA node
 *
 * Returns pointer on the RA - struct k3_nav_ringacc
...
#else
static inline void k3_nav_ringacc_ring_dump(struct k3_nav_ring *ring) {};
#endif
