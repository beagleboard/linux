 ...
 *                            removed prior to adding the list below and/or
 *                            WGPEER_F_NO_CREATE if the peer should only be
 *                            updated but fail if it does not already exist.
...
enum wgpeer_flag {
	...
	__WGPEER_F_ALL = WGPEER_F_REMOVE_ME | WGPEER_F_REPLACE_ALLOWEDIPS | WGPEER_F_NO_CREATE
};
