...
static int k3_r5_rproc_configure(struct k3_r5_rproc *kproc)
{
	...
	dev_err(dev, "boot_vector = 0x%llx, cfg = 0x%x ctrl = 0x%x stat = 0x%x\n",
...
static const struct k3_r5_rproc_dev_data k3_mcu_r5f_dev_data[] = {
	{
		.device_name	= "41000000.r5f",
		.fw_name	= "am65x-mcu-r5f0-fw",
	},
	{
		.device_name	= "41400000.r5f",
		.fw_name	= "am65x-mcu-r5f1-fw",
	},
	{
		/* sentinel */
	},
