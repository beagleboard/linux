 ...
 *  
 * Reg11 每 Should set 0xA0 for EDID fetching.
 * Reg12 每 Set the starting offset of EDID block on current segment.
 * Reg13 每 Set the number of byte to read back. The data will be put in DDC FIFO, 
 * 		   therefore, cannot exceed the size (32) of FIFO.
 * Reg14 每 The segment of EDID block to read.
 * Reg15 每 DDC command should be 0x03. 
 *  
