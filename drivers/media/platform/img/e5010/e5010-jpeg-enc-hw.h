...
int e5010_hw_set_output_size(void __iomem *core_offset, u32 val);
...
int e5010_reset(void __iomem *core_offset, void __iomem *mmu_offset);
...
bool e5010_hw_is_busy(void __iomem *core_offset);
